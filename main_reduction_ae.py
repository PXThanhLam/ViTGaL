...
def get_args_parser():
    ...
    # Model parameters
    parser.add_argument('--model', default='xcit_retrievalv2_reduction_ae', type=str, metavar='MODEL',
    ...
    parser.add_argument('--val_split', default= 'test_split.txt', type=str,
                        help='Number of class')
    parser.add_argument('--output_dir', default='model_checkpoint/xcit_small_12_p16_retrieval_reduction_ae',
    ...
    parser.add_argument("--pretrained_backbone",
                        default='model_checkpoint/xcit_small_12_p16_retrieval/checkpoint.pth', type=str, help='Path to pretrained checkpoint') 
